...
public class survey_db {
    ...
    public survey_db open() throws SQLException
    {
      //getting lock
        synchronized(dbLock)
        {
            ...
            //change some of the member variables
            databaseOpen = true;
    ...
    public void close()
    {
        //gets a lock on something
        synchronized(dbLock)
        {
            dbHelper.close();
            //reset the member variables to reflect this
            databaseOpen = false;
            dbLock.notify();
        }
    }
    ...
    public ArrayList <survey_db_row>  fetchAllEntries()
    {
        ...
        try
        {
            ...
            for (int i =0; i < numRows; ++i)
            {
                ...
                //add each survey to the arraylist of survey_db objects
                ret.add(sr);
        ...
        //return the arraylist of surveys
        return ret;
    }
